...
headers = {
    ...
    "Content-Type": "multipart/form-data; boundary=----WebKitFormBoundary3XQiX9nPGGZQwL7e"
}
...
# 遍歷用戶名列表並發送請求
for i in usernames:
    b = i.replace("a", "aa")  # 根據需求轉換 b 值
    body = f"""



    
------WebKitFormBoundary3XQiX9nPGGZQwL7e
...
02a781846bbab92e7824ca70db5131ad9a96857dc6e5cc40676518c5
------WebKitFormBoundary3XQiX9nPGGZQwL7e
